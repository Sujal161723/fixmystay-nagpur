...
const userNavItems: NavItem[] = [
  ...
  { icon: <LayoutDashboard className="w-5 h-5" />, label: 'Profile', href: '/dashboard/user' },
  { icon: <Heart className="w-5 h-5" />, label: 'Saved Properties', href: '/dashboard/user' },
  { icon: <LayoutDashboard className="w-5 h-5" />, label: 'My Activity', href: '/dashboard/user' },
  { icon: <LayoutDashboard className="w-5 h-5" />, label: 'Help & Support', href: '/dashboard/user' },
];
