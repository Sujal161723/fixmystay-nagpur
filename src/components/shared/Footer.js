...
export default function Footer() {
  ...
  const companyLinks = [
    ...
    { label: 'Partner with FMS', href: '/partner' },
      ...
      <div className="container-custom">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-12 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-xs mb-6">
              Your trusted platform for finding the perfect stay in Nagpur. From daily hotels to monthly PG stays, we've got you covered.
            </p>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-center md:text-left">
              <p className="text-muted-foreground text-xs font-medium">
                © {currentYear} FixMyStay Technologies Private Limited. All rights reserved.
              </p>
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 bg-accent px-4 py-2 rounded-full">
            ...
            <span className="text-xs font-medium text-muted-foreground">Proudly serving Nagpur & beyond</span>
          </div>
        </div>
      </div>
    </footer>
